...
class CategoryController extends Controller
{
   ...
   public function delete($cat_id){
    ...
    public function subSubIndex(){
        ...
        return view('admin.subsubcategory.subsubcategory_view',compact('categories','subsubcategories'));
    }
    ...
    public function subSubEdit($subsubcat_id){
        ...
        return view('admin.subsubcategory.subsubcategory_edit',compact('subsubcat'));
    }
